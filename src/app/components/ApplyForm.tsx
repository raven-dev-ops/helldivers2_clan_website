...
export default function ApplyForm({ botName, botIdentifier, onSuccess, onCancel }: ApplyFormProps) {
                ...
                {!successMessage && ( // Hide form after success message appears
                    <form onSubmit={handleSubmit} className={styles.form}>
                        <div className={styles.formGroup}>
                            <label htmlFor="serverName" className={styles.label}>Discord Server Name</label>
                            <input
                                type="text"
                                id="serverName"
                                value={serverName}
                        ...
                        <div className={styles.formGroup}>
                             <label htmlFor="serverId" className={styles.label}>Discord Server ID (Optional)</label>
                            <input
                                type="text"
                                id="serverId"
                                value={serverId}
                        ...
                        <div className={styles.formGroup}>
                            <label htmlFor="reason" className={styles.label}>Reason for Application (Optional)</label>
                            <textarea
                                id="reason"
                                value={reason}

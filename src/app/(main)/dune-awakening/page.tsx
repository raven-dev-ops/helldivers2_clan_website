...
const duneClasses: DuneClass[] = [
  // ... (keep existing duneClasses data)
  {
    ...
    name: 'Swordmaster',
    summary:
      'Elite Ginaz warrior excelling in honorable melee combat, tanking, and dueling.',
    ...
    abilities: [
      {
        name: 'Deflection (Starting Ability)',
        description:
          'Enter a defensive stance to deflect incoming dart projectiles.',
        details:
          'Acts as a temporary shield against ranged attacks, reflecting or negating darts. Moderate cooldown. Synergy: Pairs well with melee charges – deflect an enemy’s opening shot, then rush in.',
      },
      {
        name: 'Knee Charge',
        description:
          'A lunging melee attack that knocks down or staggers an enemy, opening them up to a finisher.',
        details:
          'Deals damage and briefly stuns. Great for closing gaps or initiating fights, allows follow-up finishers. Doubles as mobility, usable mid-air.',
      },
      {
        name: '(Speculative) Additional Melee Maneuvers',
        description: 'Hints suggest numerous dashes and other melee skills.',
        details:
          'May include upgraded deflections (e.g., "Slow Deflection") or other combo/mobility abilities.',
      },
    ],
    ...
    equipment: [
      {
        category: 'Weapons',
        description:
          'Any melee weapons (crysknives, swords, daggers, maker hooks). Iconic: dueling blade/knife. Carry a sidearm (pistol/dartgun) for ranged situations.',
      },
      {
        category: 'Armor',
        description:
          'Gear enhancing close-combat survivability. Personal Shield Belt highly recommended (strong vs bullets, weak vs melee). Heavy or Medium armor balancing protection and mobility. Upgraded Stillsuit essential for resilience.',
      },
      {
        category: 'Mods & Tech',
        description:
          'Mods boosting melee damage, stamina, shield durability (e.g., poison edge knife). Throwing knives/grenades can help soften groups.',
      },
    ],
    pros: [
  ...
  },
  {
    ...
    name: 'Bene Gesserit',
    summary:
      'Masters of manipulation and finesse, using the Voice, stealth, and agility.',
    ...
    abilities: [
      {
        name: 'Voice: Compel (Starting Ability)',
        description:
          'Use The Voice to force a target to move towards you against their will.',
        details:
          'Long-range mind-control pull. Isolates enemies, interrupts actions. Synergy: Combine with melee – compel an enemy close, then stab them. Moderate cooldown, may not work on all targets.',
      },
      {
        name: 'Invisibility (Speculative/Previewed)',
        description: 'Ability to turn invisible or highly conceal oneself.',
        details:
          'Reflects stealth training. Allows sneaking, ambushing. Likely a timed cloak or blend-into-shadows skill.',
      },
      {
        name: 'Prana Bindu Dash (Teased)',
        description: 'A "superhuman dash" – burst of speed or swift dodge.',
        details:
          'Reflects extreme reflexes. Short-range teleport-like move or rapid strafe. Used for dodging or closing gaps. Short cooldown.',
      },
      {
        name: 'Internal Alchemy (Passive/Speculative)',
        description: 'Physiological control granting passive benefits.',
        details:
          'May include poison resistance or enhanced effects from spice ("the more spice you take... the more powerful"). Could boost abilities or grant unique effects.',
      },
      {
        name: '(Future) Nerve Strike / Psychic Suggestion',
        description: 'Possible future abilities fitting the theme.',
        details:
          'Nerve Strike (paralyzing melee), Psychic Suggestion (stun/confuse).',
      },
    ],
    ...
    equipment: [
      {
        category: 'Weapons',
        description:
          'Light, close-range weapons. Knives/daggers (thematic, Gom Jabbar reference). Crysknife potent choice. Silent/quick dart guns or pistols, possibly with poison. Toxin-coated weapons fit the theme.',
      },
      {
        category: 'Armor',
        description:
          'Light armor or robes for maximum agility ("Weirding Way suit," light combat stilgar). Avoid heavy encumbrance. Personal Shield possible, but may interfere with stealth. High-quality Stillsuit crucial for scouting.',
      },
      {
        category: 'Tools',
        description:
          'Spice amplifiers, infiltration gadgets (sound distraction devices). Truthsayer elixir (if exists) for detection. Grenades/flash bombs for emergencies. Gear augmenting subtlety/speed (camouflage, muffling boots, antidotes).',
      },
    ],
    pros: [
  ...
  },
  {
    ...
    name: 'Mentat',
    summary:
      'Human computers focused on recon, strategy, and technology (turrets, drones).',
    ...
    abilities: [
      {
        name: 'The Sentinel (Starting Ability)',
        description:
          'Deploy a suspensor-buoyed dart projector turret with motion detection.',
        details:
          'Placeable turret for area denial and defense. Covers flanks, fortifies positions. Fires automatically at moving enemies. Duration or ammo limited. Kite enemies into its range.',
      },
      {
        name: 'Battlefield Calculation (Scan)',
        description: 'Scan nearby enemies and objects for information.',
        details:
          'Provides HUD readouts (health, weaknesses, status?). Marks objects/traps. Ultimate situational awareness. Short cooldown or toggle. Helps focus fire and exploration.',
      },
      {
        name: 'Hunter Seeker Drone',
        description: 'Deploy and control a small stealth assassination drone.',
        details:
          'First-person controlled drone. Silently kills unaware/stationary targets with a single dart. Highlights moving targets. Limited range, expires after use/miss. Stealth takedown option.',
      },
      {
        name: 'Shield Wall (Defensive Gadget/Datamined)',
        description: 'Potentially deployable cover or energy shield.',
        details:
          'Could be a static force-field barrier for temporary cover. Blocks incoming fire. Useful under ambush or holding points.',
      },
      {
        name: 'Recon Drone (Speculative)',
        description: 'Possible scouting drone for intel gathering.',
        details:
          'Less lethal than Hunter Seeker. Might tag enemies or share radar info. Could enhance vehicle scanners.',
      },
      {
        name: 'Passive Analytical Enhancements',
        description: 'Likely passives improving intel gathering or crafting.',
        details:
          'Bonus loot from scanned items, efficient tech crafting, deciphering data.',
      },
    ],
    ...
    equipment: [
      {
        category: 'Weapons',
        description:
          'Reliable mid- to long-range firearms. Dart rifle or sniper rifle pairs well with recon. Pistol/SMG sidearm. Knife for emergencies/stealth.',
      },
      {
        category: 'Armor',
        description:
          'Medium armor or tactical bodysuit. Balance protection and mobility. Gear with tech slots/gadget capacity. Personal Shield useful for deploying devices under fire.',
      },
      {
        category: 'Tools & Gadgets',
        description:
          'Bread and butter. Mines, traps, scanners. Hacking tools (if exist). Rangefinder/binoculars. Vehicles fitted with scanners/comms. Intel gear (upgraded visors). Stock up on consumables (drones, turret ammo?).',
      },
    ],
    pros: [
  ...
  },
  {
    ...
    name: 'Trooper',
    summary:
      'Conventional soldiers focused on offense, demolition, and mobility via grappling hook.',
    ...
    abilities: [
      {
        name: 'Shigawire Cable (Starting Ability)',
        description:
          'Shoot a barb on a line to rapidly pull yourself to a surface.',
        details:
          'Grappling hook for exploration and combat. Reach high ledges, cross gaps, gap-close, escape. Short cooldown encourages repositioning. Likely limited to surfaces initially.',
      },
      {
        name: 'Grenades / Explosives',
        description:
          'Likely active skills related to throwing grenades or setting charges.',
        details:
          'Core focus on demolition. Expect Frag Grenade ability or similar. May have traits boosting explosive damage/radius or ability to carry more.',
      },
      {
        name: 'Shigawire Claw (Alternate Grapple)',
        description: 'Possible grappling hook variant or upgrade.',
        details:
          'Mentioned in exploration blog. Might allow grappling creatures/players, pulling enemies (Scorpion style), or entangling.',
      },
      {
        name: 'Suppressive Fire / Heavy Weapon Training (Speculative)',
        description:
          'Possible skill boosting rate of fire, damage, or heavy weapon use.',
        details:
          'Could be "Adrenaline Rush" (reload/recoil boost) or "Suppressive Stance." Might use lasguns/rifles more effectively.',
      },
      {
        name: 'Demolition Charge (Speculative)',
        description:
          'Possible ability to set charges damaging structures/vehicles.',
        details:
          'Fits siege/demolition theme. Useful for breaching or destroying objectives.',
      },
      {
        name: 'Close-Combat Training (Speculative)',
        description: 'Basic melee capability.',
        details:
          'Maybe bayonet charge, buttstroke, or simple "Brutal Strike" knockback.',
      },
    ],
    ...
    equipment: [
      {
        category: 'Weapons',
        description:
          'Masters of firearms. Assault rifles, sniper rifles, shotguns, SMGs. Projectile weapons (dart guns, maula pistols), lasguns possible. Carry multiple weapons for different ranges. Explosives (grenades). Knife backup.',
      },
      {
        category: 'Armor',
        description:
          'Combat armor for solid protection (House uniforms, CHOAM Assault gear?). High defense preferred, watch weight. Shield Belt useful vs ranged, risky vs melee.',
      },
      {
        category: 'Mods & Utilities',
        description:
          'Weapon attachments (scopes, stabilizers). Spice-infused ammo? Ammo packs/restock items. Detonators/breaching charges. Upgraded grappling hook (faster reel?). Night-vision/targeters?',
      },
      {
        category: 'Vehicles',
        description:
          'Likely best at using combat vehicles (buggy turrets, combat ornithopters). Gear could align with vehicle mods.',
      },
    ],
    pros: [
  ...
  },
  {
    ...
    name: 'Planetologist',
    summary:
      'Masters of desert survival, resource gathering, exploration, and Fremen ways.',
    ...
    abilities: [
      {
        name: 'Desert Survival (Passive/Skill)',
        description:
          'Greatly reduced resource consumption and environmental hazard resistance.',
        details:
          'Slower water depletion, more hydration from kills, less damage from heat/storms. Allows longer desert excursions.',
      },
      {
        name: 'Resource Finder (Scan)',
        description: 'Ability to detect resources like spice, water, minerals.',
        details:
          'Highlights nodes on HUD. Might involve "tasting the sand." Invaluable for gathering.',
      },
      {
        name: 'Cartographer (Sinkchart Creation)',
        description:
          'Skill to create tangible maps (Sinkcharts) of explored regions.',
        details:
          'Records layout of changing desert. Maps can be shared/sold. Requires visiting vantage points and launching survey probes. Crucial for exploration meta.',
      },
      {
        name: 'Thumper (Worm Summoning/Diversion)',
        description:
          'Potential ability/tool to use thumpers for manipulating sandworms.',
        details:
          'Attracts worms. Use to eliminate enemies, create blockades, divert chasing worms, or potentially call worms for riding (future?). Epitomizes "desert power."',
      },
      {
        name: 'Spice Chemurgy / Poison',
        description: 'Knowledge of using spice or plants for effects.',
        details:
          'Craft poisons/sedatives for weapons/supplies. Use spice for detection/visions? May have ability to apply toxins (damage over time).',
      },
      {
        name: 'Terrain Mastery (Movement)',
        description:
          'Enhanced movement on sand, potentially mimicking Fremen techniques.',
        details:
          'Move silently/quickly over sand ("walk without rhythm") to avoid worms. Better climbing/parkour in rocks?',
      },
      {
        name: 'Maker Hooks (Speculative Future Ability)',
        description:
          'Potential high-level ability to ride sandworms using maker hooks.',
        details:
          'Ultimate expression of desert power. Likely rare/quest-tied. Pinnacle of Planetologist lore.',
      },
    ],
    ...
    equipment: [
      {
        category: 'Weapons',
        description:
          'Survival tools doubling as weapons. Crysknife (iconic Fremen dagger). Lightweight ranged defense (dart rifle, Maula pistol). Small explosives/charges for utility (avalanches, breaching rock) more than pure damage.',
      },
      {
        category: 'Armor',
        description:
          'Best quality Stillsuit essential. Layered desert robes for protection/camouflage. Light armor pieces. Avoid heavy armor. Gear with utility slots.',
      },
      {
        category: 'Tools',
        description:
          'Maker Hook & Thumper (if available). Fremkit (survival kit). Surveyor Probes. Spice harvesters/collectors. Dew Collectors/water distillers. Desert Compass (storm navigation?). Sand Goggles/mask (storm vision, heat detection?). Spice filters/injector. Map case/satchel.',
      },
    ],
    pros: [
...
const youtubeVideos: YoutubeVideo[] = [
  {
    id: 'DuneAwakeningTrailer1',
    embedUrl: 'https://www.youtube.com/embed/plw2gxf7Coc?si=6jvS0yPyjY39Hyww',
  },
  {
    id: 'DuneGameplayReveal',
    embedUrl: 'https://www.youtube.com/embed/r8lxVDqoHLQ?si=OmYVnWHeEmKv4EPL',
  },
  {
    id: 'DuneSurvivalMechanics',
    embedUrl: 'https://www.youtube.com/embed/UA4Q8dTuIio?si=aN77qr5ihaBplfnu',
  },
];
...
const reviews: Review[] = [
  {
    id: 1,
    author: 'ArrakisExplorer',
    title: 'Promising Survival Mechanics',
    text: 'Really looking forward to the survival aspects shown. Managing water and avoiding worms looks intense! Hope the community building is strong.',
    rating: 5,
  },
  {
    id: 2,
    author: 'SpiceTrader88',
    title: 'Potential for Deep Faction Play',
    text: 'The idea of House politics and CHOAM influencing the world has me hooked. If they pull off the faction rivalries, this could be huge.',
    rating: 4,
  },
  {
    id: 3,
    author: 'SandWalker',
    title: 'Visually Stunning Arrakis',
    text: 'From the previews, the depiction of Arrakis looks incredible. The scale of the desert and the storms seem spot on. Cautiously optimistic about performance.',
    rating: 5,
  },
  {
    id: 4,
    author: 'Duke_Fan',
    title: 'Great Roleplay Potential!',
    text: "Heard about the community roleplay with 'Duke Richard' and the Fremen council. Sounds like a fun, unique group that values story.",
    rating: 5,
  },
  {
    id: 5,
    author: 'SchematicSeeker',
    title: 'Neutral Trading Hub?',
    text: 'Looking for a reliable place to trade schematics without getting ripped off by big clans. If this group is truly neutral and has integrity, count me in.',
    rating: 5,
  },
  {
    id: 6,
    author: 'DesertNomad',
    title: 'Casual & Hardcore Welcome',
    text: 'Good to see a community aiming to bridge the gap between casual players and hardcore survivalists. Merit-based sounds fair.',
    rating: 4,
  },
];
    ...
    <div className={styles.pageContainer}>
      ...
      <section className={styles.section}>
        ...
        <p className={styles.paragraph}>
          Welcome, adventurer, to the harsh deserts of Arrakis. In Dune:
          Awakening, your survival and success depend not only on your wits and
          gear but also on the specialized training you undertake and the allies
          you choose. The Galactic Phantom Taskforce (GPT) Dune Division offers
          a haven.
        </p>
        <p className={styles.paragraph}>
          This guide provides an overview of the known playable classes or
          specializations available. Below, you'll also find information about
          our community and how we operate on Arrakis. Choose your path wisely,
          learn its strengths and weaknesses, and remember that adaptability is
          key to surviving the dangers of Dune. Click on a class below to expand
          its details.
        </p>
      </section>
      ...
      <section className={styles.section}>
        ...
        <p className={styles.paragraph}>
          Feeling the heat? Overwhelmed by the sandworms or the scarcity of
          water? GPT is here to help. We offer a supportive environment for
          those taking their first steps onto the shifting sands. Learn the
          essentials of survival, crafting, and navigation without fear of
          judgment.
        </p>
        <p className={styles.paragraph}>
          Our experienced members can guide you through finding resources,
          understanding faction dynamics, and joining your first group
          expeditions. Ask questions, find mentors, and discover the secrets of
          the desert alongside friendly faces. Check our Discord for guides and
          LFG channels!
        </p>
      </section>
          ...
          return (
            <div key={duneClass.id} className={styles.factionCard}>
              <div
                ...
                onKeyDown={(e) =>
                  (e.key === 'Enter' || e.key === ' ') &&
                  toggleClassExpansion(duneClass.id)
                }
              >
                <div>
                ...
                {isExpanded ? (
                  <FaChevronUp
                    className={`${styles.expandIcon} ${styles.rotated}`}
              ...
              <div
                ...
                className={`${styles.factionContentContainer} ${isExpanded ? styles.collapsibleContentExpanded : ''}`}
              >
                ...
                <ul className={styles.ruleList}>
                  {duneClass.abilities.map((ability, idx) => (
                    <li key={idx} className={styles.ruleListItem}>
                      <span className={styles.strongText}>{ability.name}:</span>{' '}
                      {ability.description}
                      {ability.details && (
                        <span className={styles.abilityDetails}>
                          {' '}
                          {ability.details}
                        </span>
                      )}
      ...
      <section className={styles.section}>
        ...
        <p className={styles.paragraph}>
          GPT aims to be more than just a clan; we are an established community
          built on{' '}
          <strong className={styles.strongText}>integrity and trust</strong>. We
          welcome both casual explorers and hardcore survivors, operating as a
          merit-based group at heart. We foster a unique atmosphere with
          satirical roleplay featuring our noble "Duke Richard," the prowess of
          "Muad'Dib" (our champion fighter), and the wisdom of our council of
          Fremen Elders and refugees.
        </p>
        <p className={styles.paragraph}>
          We envision our community as a{' '}
          <strong className={styles.strongText}>neutral trading ground</strong>{' '}
          for the Dune market. We encourage the open sharing of schematics and
          resources, providing a safe and reliable hub away from the grasp of
          larger, potentially domineering factions. If you seek fair trade and
          collaboration, look no further.
        </p>
        <p className={styles.paragraph}>
          Our ultimate goal aligns with the Fremen dream: to see Arrakis
          restored and its people thrive. We stand against tyrannical clans and
          hateful groups unwilling to let the spice flow freely for the benefit
          of all. If your group shares these values or seeks a dependable ally
          and trading partner,{' '}
          <Link
            href={discordServerLink}
            target="_blank"
      ...
      <div className={styles.reviewSectionContainer}>
        <div
          className={`${styles.reviewCardsWrapper} ${!isReviewVisible ? styles.reviewCardsWrapperHidden : ''}`}
        >
            ...
            reviewsToShow.map((review) => (
              <div key={review.id} className={styles.individualReviewCard}>
                <div className={styles.reviewStars}>
                  {Array.from({
                    length: Math.max(0, Math.min(5, review.rating)),
                  }).map((_, i) => (
                    <FaStar key={i} />
                  ))}
                  {Array.from({ length: Math.max(0, 5 - review.rating) }).map(
                    (_, i) => (

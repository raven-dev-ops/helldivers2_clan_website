...
const styles = {
  ...
  videoBackground: {
    ...
    left: '50%',
    width: 'auto',
    height: 'auto', // Let browser determine initial size
    minWidth: '100%',
    minHeight: '100%', // Force cover
    objectFit: 'cover',
  ...
  discordButtonHover: {
    backgroundColor: '#4f5bda',
    borderColor: '#4f5bda',
    transform: 'translateY(-2px)',
    boxShadow: '0 6px 12px rgba(88, 101, 242, 0.35)',
  } as React.CSSProperties,
  googleButton: {
  ...
  } as React.CSSProperties, // Generic focus style
  ...
  audioControlFocus: {
    boxShadow: '0 0 0 3px rgba(66, 153, 225, 0.6)',
  } as React.CSSProperties, // Focus for audio button
...
export default function AuthPage() {
  ...
  if (status === 'unauthenticated') {
    ...
    const discordFinalStyle = {
      ...styles.buttonBase,
      ...styles.discordButton,
      ...(discordHover ? styles.discordButtonHover : {}),
      ...(discordFocus ? styles.buttonFocusVisible : {}),
    };
    const googleFinalStyle = {
      ...styles.buttonBase,
      ...styles.googleButton,
      ...(googleHover ? styles.googleButtonHover : {}),
      ...(googleFocus ? styles.buttonFocusVisible : {}),
    };
    const audioControlFinalStyle = {
      ...styles.audioControl,
      ...(audioControlHover ? styles.audioControlHover : {}),
      ...(audioControlFocus ? styles.audioControlFocus : {}),
    }; // Use specific focus style
    const audioCreditFinalStyle = {
      ...styles.audioCredit,
      ...(isPlaying ? styles.audioCreditVisible : {}),
    };
    const audioCreditLinkFinalStyle = {
      ...styles.audioCreditLink,
      ...(anthemLinkHover ? styles.audioCreditLinkHover : {}),
    };
    const volumeSliderContainerFinalStyle = {
    ...
    return (
      <div style={styles.authContainer} onClick={handleInteraction}>
        ...
        <div style={styles.audioControlsContainer}>
          <div
            style={styles.audioButtonAndSliderContainer}
